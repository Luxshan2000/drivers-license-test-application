  ...
  return (
    <div style={{userSelect:'none'}} className='mt-3 p-0 mb-3 border border-1  shadow-sm   container rounded-3   justify-content-center'>
        <div 
          ...
          <div className=' text-start row pe-1 '>
        ...
        <hr className=' mt-0 m-1'/>
          <div className='rounded-3 mb-3 p-3 pb-0 '  >
              <h5  className='text-start p-1 CourseSubHeading'><a href='/content' style={{cursor:'pointer'}}>{heading.subHeadings[0]}</a></h5>
              <h5  className='text-start p-1 CourseSubHeading'><a href='/quiz' style={{cursor:'pointer'}}>{heading.subHeadings[1]}</a></h5>
          </div>
        </div>
    </div>
  )
